...
namespace Vehicle_Management.Controllers
{
	public class DriverController : Controller
	{
        ...
        public DriverController(ILogger<HomeController> logger, ApplicationDbContext dbContext, UserManager<UserManager> userManager, NotificationHub notification, NotificationService notificationService)
		{
